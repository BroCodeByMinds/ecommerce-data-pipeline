...
from common.constants import ErrorMessages, ResponseFields, StatusCodes
from web.models.response_models import UserStatsResponse, GlobalStatsResponse
...
async def user_stats(user_id: str, service: StatsService = Depends(get_stats_service)):
    ...
    return ResponseBuilder.success(data=response_data.model_dump())
